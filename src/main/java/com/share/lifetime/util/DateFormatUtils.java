...
public class DateFormatUtils {
	...
	/**
	 * 
	 * 分析日期字符串, 仅用于日期格式“yyyy-MM-dd”
	 * 
	 * @param dateString
	 * @return
	 * @throws ParseException 
	 */
	public static Date parseByDayPattern(String dateString) throws ParseException {
		return parseDate(PATTERN_ISO_ON_DATE, dateString);
	}

	/**
	 * 分析日期字符串, 仅用于日期格式“yyyy-MM-dd HH:mm:ss”
	 *
	 * @param str
	 * @return
	 * @throws ParseException 
	 */
	public static Date parseByDateTimePattern(String dateString) throws ParseException {
		return parseDate(PATTERN_DEFAULT_ON_SECOND, dateString);
	}
	...
	public static String formatByDayPattern(Date date) {
		if (date != null) {
			return DateFormatUtils.formatDate(PATTERN_ISO_ON_DATE, date);
		} else {
			return null;
		}
	}
	...
	/**
	 * 格式化日期, 仅用于“yyyy-MM-dd HH:mm:ss”
	 *
	 * @param date
	 * @return
	 */
	public static String formatByDateTimePattern(Date date) {
		return DateFormatUtils.formatDate(PATTERN_DEFAULT_ON_SECOND, date);
	}

	/**
	 * 获取当前日期, 使用“YYYY MM DH HH:MM:SS”格式化日期
	 * @return
	 */
