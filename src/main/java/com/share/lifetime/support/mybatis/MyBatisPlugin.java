...
public class MyBatisPlugin implements Interceptor {
    ...
    private String getSQLDatabase() {
        ...
        String url = SQL_URL_CACHE.get(dbName);
        if (url != null) {
            return url;
        }
    ...
    private DataSource getDataSource() {
        ...
        log.error(
            String.format("---the transaction is not SpringManagedTransaction:%s", transaction.getClass().toString()));
